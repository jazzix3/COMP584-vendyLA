            ...
            <div className="container pt-3 dash-container mb-3" id="main-content" style={{ overflow: 'hidden', borderRadius: '10px', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.9)' }}>
                ...
                <div className ="wave-box">
                        ...
                        <g className="parallax">
                            <use xlinkHref="#gentle-wave" x="48" y="0" fill="rgba(202,72,72,0.7" />
                            <use xlinkHref="#gentle-wave" x="48" y="3" fill="rgba(202,72,72,0.5)" />
                            <use xlinkHref="#gentle-wave" x="48" y="5" fill="rgba(202,72,72,0.3)" />
                            <use xlinkHref="#gentle-wave" x="48" y="7" fill="#feb555" />
